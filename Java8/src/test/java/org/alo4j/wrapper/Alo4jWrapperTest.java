...
//		}
	...
	public void lambda_function1() throws Exception {
		String result = "";
		try{
			loggerWrapper.when(true).debug(()->{return "this is debug in F.run";});
...
//			}
	...
	public void lambda_condition() throws Exception {
		String result = "";
		try{
			loggerWrapper.when(()->{return true;})
					.trace(()->{return "this should be printed";});
...
//			}
	...
	public void lambda_condition2() throws Exception {
		String result = "";
		try{
			loggerWrapper.when(()->{return false;})
					.trace(()->{return "this should be printed";});
