...
import org.alo4j.wrapper.Condition;
...
public class Alo4jHelperTest {
	...
	@Test
	public void begin_method_with_object_param() throws Exception {
		String result = null;
		
		try{
			PrintLine tester = new PrintLine();
			tester.printMethodBeginWithObjectParam(new IterableVariable());
			// without static import
			// logWrapper.trace(Alo4jHelper.methodBegin(iterable));

			// with static
			// logWrapper.trace(methodBegin(iterable));
		...
		String expected = 
				"Begin method [printMethodBeginWithObjectParam]\n" + 
				"param[0]<resources.variable.IterableVariable>\n" + 
				"> param[0].stringList[0]: abc\n" + 
				"> param[0].stringList[1]: def\n" + 
				"> param[0].stringList[2]: ghi\n" + 
				"> param[0].intCollection[0]: 1\n" + 
				"> param[0].intCollection[1]: 2\n" + 
				"> param[0].intCollection[2]: 3\n" + 
				"> param[0].doubleIterable[0]: 1.2\n" + 
				"> param[0].doubleIterable[1]: 3.4\n" + 
				"> param[0].doubleIterable[2]: 5.6";
